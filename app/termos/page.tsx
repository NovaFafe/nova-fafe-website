      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 prose prose-gray max-w-none">
          <div className="space-y-10 text-muted-foreground leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-4">1. Identificação</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-4">2. Utilização do Website</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-4">3. Serviços e Contratação</h2>
              <p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-4">4. Cancelamentos e Reembolsos</h2>
              <p>
