...
const courses = [
  {
    ...
    features: ["32 aulas práticas", "Exame teórico incluso", "Material didático", "Acompanhamento personalizado"],
    popular: true,
  ...
  },
  {
    ...
    category: "A / A1 / A2",
    description: "Formação para as três subcategorias — A1 (16 anos/125cc), A2 (18 anos/35 kW) e A (24 anos/55 kW ou 2 anos de A2).",
    features: ["A1, A2 e A", "Equipamento fornecido", "Acesso direto ou progressivo", "Treino intensivo"],
    popular: false,
  ...
  },
  {
    ...
    category: "Em parceria",
    description: "Formação para pesados de passageiros e mercadorias, TCC e CAM — em parceria, para quem quer trabalhar no transporte rodoviário.",
    features: ["Pesados passageiros e mercadorias", "TCC e CAM", "Acompanhamento na inscrição", "Sob consulta"],
    popular: false,
  ...
  },
  {
    ...
    category: "Tratores · Troca · Revalidação",
    description: "Tratores agrícolas, troca de carta estrangeira e revalidação de títulos — tratamos do processo contigo.",
    features: ["Tratores agrícolas", "Troca de carta estrangeira", "Revalidação de carta", "Apoio IMT"],
    popular: false,
...
export function Courses() {
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-7 sm:px-8 lg:px-12">
